...
@section('content')
    ...
    <section class="section-slide">
        <div class="wrap-slick1 rs2-slick1">
            <div class="slick1">
                <div class="item-slick1 bg-overlay1" style="background-image: url({{asset('images/books-1.jpg')}});" data-thumb="images/thumb-01.jpg" data-caption="Women’s Wear">
                ...
                <div class="item-slick1 bg-overlay1" style="background-image: url({{asset('images/book-2.jpg')}});" data-thumb="images/thumb-02.jpg" data-caption="Men’s Wear">
                    <div class="container h-full">
                        <div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
                ...
                <div class="item-slick1 bg-overlay1" style="background-image: url({{asset('images/book-3.jpg')}});" data-thumb="images/thumb-03.jpg" data-caption="Men’s Wear">
                    <div class="container h-full">
                        <div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
